...
export const EXERCISES: Exercise[] = [
  // ── Activation / mobilité (échauffement) ──────────────────────────────────
  {
    ...
    sets: 1, duration_sec: 40, rest_sec: 15,
  },
  {
    ...
    sets: 1, duration_sec: 30, rest_sec: 10,
  },
  {
    slug: "chat_vache",
    name: "Chat vache",
    ...
    category: "activation_mobilite", equipment: "none", mode: "duration", unilateral: false,
    sets: 1, duration_sec: 45, rest_sec: 15,
  },
  {
  ...
  },
  {
    ...
    sets: 3, duration_sec: 45, rest_sec: 45,
  },
  ...
  // ── Gainage ───────────────────────────────────────────────────────────────
  {
    ...
    sets: 3, duration_sec: 60, rest_sec: 30,
  },
  {
  ...
  },
  {
    ...
    category: "gainage", equipment: "none", mode: "duration", unilateral: false,
    sets: 3, duration_sec: 30, rest_sec: 40,
  },
  {
    slug: "releve_jambes",
  ...
  },
  {
    ...
    sets: 3, duration_sec: 20, rest_sec: 40,
  },
  {
    ...
    category: "gainage", equipment: "chair", mode: "duration", unilateral: true,
    sets: 3, duration_sec: 20, rest_sec: 45,
  },
 ...
 * exercice « slug | category | mode | equipment », groupé par catégorie, SANS
 * les descriptions (économie de tokens).
 */
export const CATALOG_SUMMARY: string = (() => {
  ...
  for (const [cat, list] of byCat) {
    ...
    for (const e of list) {
      ...
      lines.push(`  ${e.slug} · ${e.mode} · ${e.equipment}${uni}`)
    }
  }
  return lines.join("\n")
})()
